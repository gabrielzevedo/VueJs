...
<div class="contain">
  ...
  <serie v-for="serie in series" v-bind:key="serie.id" v-bind:titulo="serie.titulo" v-bind:temporadas="serie.temporadas"></serie>
...
<script>
    ...
    import Serie from '../componentes/Serie.vue';
    ...
    export default {
        ...
        created() {
            ...
            this.$http.get('http://localhost:3000/series').then(res => {
